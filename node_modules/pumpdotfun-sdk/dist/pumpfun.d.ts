...
export declare class PumpFunSDK {
    ...
    buy(globalAccount:GlobalAccount,bondingCurveAccount:BondingCurveAccount,buyer: Keypair, mint: PublicKey, buyAmountSol: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
    sell(seller: Keypair, mint: PublicKey, sellAmount: bigint, slippageBasisPoints?: bigint, priorityFees?: PriorityFee, commitment?: Commitment, finality?: Finality): Promise<TransactionResult>;
